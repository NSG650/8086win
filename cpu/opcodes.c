...
const struct opcode opcodes[256] = {
        ...
        {"RET imm16", 1, NULL},
        {"RET", 0, NULL},
        {"LES r16, m16:16", 2, NULL},
        {"LDS r16, m16:16", 2, NULL},
        {"MOV r8, m8", 2, NULL},
        {"MOV r16, m16", 2, NULL},
        {"ENTER", 0, NULL},
        {"LEAVE", 0, NULL},
